...
$Payment = array(
    'amt' => $_SESSION['shopping_cart']['items'][2]['price'] + $_SESSION['shopping_cart']['items'][1]['price_addon'],    // Required.  The total cost of the transaction to the customer.  If shipping cost and tax charges are known, include them in this value.  If not, this value should be the current sub-total of the order.
    'currencycode' => 'USD',
    'itemamt' => $_SESSION['shopping_cart']['items'][2]['price'],       // Subtotal of items only.                                            // A three-character currency code.  Default is USD.
    'shippingamt' => $_SESSION['shopping_cart']['items'][2]['shipping'],     // Total shipping costs for this order.  If you specify SHIPPINGAMT you mut also specify a value for ITEMAMT.
    'handlingamt' => $_SESSION['shopping_cart']['items'][2]['handling'],     // Total handling costs for this order.  If you specify HANDLINGAMT you mut also specify a value for ITEMAMT.
    'taxamt' => $_SESSION['shopping_cart']['items'][2]['tax'],          // Required if you specify itemized L_TAXAMT fields.  Sum of all tax items in this order.
    'paymentaction' => 'Sale',
    'sellerpaypalaccountid' => $_SESSION['shopping_cart']['items'][2]['seller_id'],         // A unique identifier for the merchant.  For parallel payments, this field is required and must contain the Payer ID or the email address of the merchant.
    'paymentrequestid' => 'CART26488-PAYMENT2'
);
array_push($Payments, $Payment);
