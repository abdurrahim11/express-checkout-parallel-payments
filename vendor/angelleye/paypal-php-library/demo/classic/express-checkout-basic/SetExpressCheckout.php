...
$SECFields = array(
					...
					'returnurl' => $domain . 'express-checkout/GetExpressCheckoutDetails.php', 							    // Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
					'cancelurl' => $domain . 'express-checkout/', 							    // Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
